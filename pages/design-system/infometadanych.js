...
import DesignSystem_LayoutDisplay from "../../components/DesignSystem/DesignSystemLayoutDisplay";
...
export default function DesignSystem_PelnyWidok() {
  return (
    <>
      <DesignSystem_LayoutDisplay title="InfoMetadanych">
        <InfoMetadanych />
